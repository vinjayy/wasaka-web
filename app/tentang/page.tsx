            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <p className="text-base lg:text-lg text-muted-foreground leading-relaxed mb-4">
                  PT. Wasaka Cipta Energindo merupakan perusahaan yang bergerak
                  di bidang energi dan logistik, dengan fokus pada layanan
                  transportasi BBM, penjualan solar industri, serta hauling
                  pertambangan batubara.
                </p>
                <p className="text-base lg:text-lg text-muted-foreground leading-relaxed">
                  Kami berkomitmen memberikan layanan yang efisien, aman, dan
                  sesuai standar operasional industri. Dengan pengalaman dan
                  dedikasi tinggi, kami hadir sebagai mitra terpercaya dalam
                  mendukung kebutuhan energi dan logistik industri Anda.
                </p>
              </div>
              ...
              <div>
                <div className="relative aspect-[4/3] rounded-2xl overflow-hidden shadow-lg">
                  <Image
                    src="/profil.jpeg"
                    alt="Profil PT Wasaka Cipta Energindo"
                    fill
                    priority
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
              ...
              <Card className="border-2">
                <CardContent className="p-8 lg:p-10">
                  ...
                  <p className="text-base lg:text-lg text-muted-foreground leading-relaxed">
                    Menjadi perusahaan energi dan logistik yang terpercaya,
                    profesional, dan berdaya saing tinggi di Indonesia.
                  </p>
                </CardContent>
              </Card>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-2 lg:order-1">
                <div className="relative aspect-[4/3] rounded-2xl overflow-hidden shadow-lg">
                  <Image
                    src="/komitmen.jpeg"
                    alt="Komitmen PT Wasaka Cipta Energindo"
                    fill
              ...
              <div className="order-1 lg:order-2">
                ...
                <p className="text-base lg:text-lg text-muted-foreground leading-relaxed">
                  ...
                  profesionalisme dalam setiap aspek operasional. Keselamatan,
                  ketepatan waktu, dan kepuasan pelanggan adalah prioritas utama
                  kami dalam menjalankan bisnis.
                </p>
              </div>
            </div>
          </div>
