...
export default function KontakPage() {
  const contactInfo = [
    ...
    },
    {
      ...
      content: ["0511-5213014", "+62 823-1053-2025"],
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        ...
        {/* Google Maps */} <section className="w-full bg-slate-50"> <div className="container mx-auto max-w-7xl px-6 lg:px-8 py-16 lg:py-24"> <div className="text-center mb-8"> <h2 className="text-3xl lg:text-4xl font-bold text-slate-900 mb-4">Lokasi Kantor</h2> <p className="text-base lg:text-lg text-muted-foreground">Kunjungi kantor kami di Kalimantan Selatan</p> </div> <div className="rounded-2xl overflow-hidden shadow-lg border-2 border-gray-200"> <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3982.953407396869!2d114.82!3d-3.45!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zM8KwMjcnMDAuMCJTIDExNMKwNDknMTIuMCJF!5e0!3m2!1sen!2sid!4v1234567890" width="100%" height="450" style={{ border: 0 }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="Lokasi PT. Wasaka Cipta Energindo" /> </div> </div> </section> </main>
